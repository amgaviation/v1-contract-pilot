...
export const HELP_SECTIONS: readonly HelpSection[] = [
  ...
  },
  {
    ...
    topics: [
      ...
      {
        id: "account-hold",
        title: "Putting your account on hold",
        summary: "Pause billing for up to two months without losing anything.",
        href: "/settings?tab=account",
        body: [
          "A hold pauses your billing for one or two months and puts your records in read-only. Nothing is deleted while it runs, everything stays exportable, and you can end it early whenever you want. It is there for the season when you are not flying.",
          "You can place one once you have been billing for two months or more.",
          "A hold cannot run longer than two months. If it runs out and you have not resumed or paid to keep your data, the business side is cleared: clients, trips, invoices, estimates, expenses and the accounting ledger.",
          "Your logbook, your documents, your aircraft and your operator qualifications are kept whatever happens. Those are your records as an airman, and a subscription lapse is never what destroys them.",
        ],
        keywords: [
          "hold",
          "pause",
