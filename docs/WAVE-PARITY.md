...
**Totals across the 37 scored rows, updated after this session's builds: 13 MATCHED · 10 MATCHED-DIFFERENTLY · 0 IN PROGRESS THIS
SESSION · 8 GAP · 6 DELIBERATELY EXCLUDED.** (At audit time the split was 9 · 10 · 2 · 10 · 6; the
session closed both in-progress rows and the two largest buildable gaps — estimates UI and the
sales tax report.) (Two cross-reference rows — 2.4 and 6.4 —
