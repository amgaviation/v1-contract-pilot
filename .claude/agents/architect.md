...
- Establish the root cause or the design constraints before proposing anything.
- Give one recommended approach with its tradeoffs, not a menu.
- Name the critical files and the order of changes.
- If the fix is actually simple, say so and hand it back - do not gold-plate.
